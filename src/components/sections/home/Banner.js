...
const Banner = () => {
  ...
  <section className="banner_section banner_style_1 decoration_wrap" style={{ backgroundImage: 'url(images/background/shape_bg_1.png)' }}>
    <div className="section_overlay" style={{ backgroundImage: 'url(images/overlay/shapes_overlay_1.svg)' }}></div>
    <div className="container">
      <div className="banner_content">
        <h1 className="banner_title">The World's Best Team for Pet Care Services</h1>
        <p className="banner_description">
          Consequat nisl vel pretium lectus quam id leo in. Quis viverra nibh cras pulvinar mattis. Quis hendrerit dolor magna eget est lorem ipsum dolor
        </p>
        <Link className="btn btn_primary" href="page-services">
    ...
    <div className="decoration_item shape_1">
      <svg width="385" height="384" viewBox="0 0 385 384" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="192.243" cy="192" r="190" stroke="url(#shape_circle_1)" strokeWidth="4" strokeLinecap="round" strokeDasharray="107 107"/>
        ...
        <defs>
          <linearGradient id="shape_circle_1" x1="-30.159" y1="-153.951" x2="-30.159" y2="290.853" gradientUnits="userSpaceOnUse">
            <stop offset="1" stopColor="#CCA162"/>
            <stop offset="1" stopColor="#CCA162" stopOpacity="0.01"/>
          </linearGradient>
        </defs>
      </svg>
    </div>
    <div className="decoration_item shape_2">
      <svg width="385" height="384" viewBox="0 0 385 384" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="192.243" cy="192" r="190" stroke="url(#shape_circle_2)" strokeWidth="4" strokeLinecap="round" strokeDasharray="107 107"/>
