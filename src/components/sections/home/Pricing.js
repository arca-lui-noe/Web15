  ...
  <section className="pricing_section bg_gray section_space_lg decoration_wrap">
    <div className="container">
      <div className="section_title text-center">
        <h2 className="title_text"><span className="sub_title">Our prices</span> Dog Grooming Services & Pricing</h2>
      ...
      <div className="pricing_tab_wrap">
        <ul className="nav tabs_nav unorder_list_center" role="tablist">
          <li className="nav-item"><button className={activeIndex === 1 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(1)} data-tab="#tab1">Small Dog</button></li>
          <li className="nav-item"><button className={activeIndex === 2 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(2)} data-tab="#tab2">Medium Dog</button></li>
          <li className="nav-item"><button className={activeIndex === 3 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(3)} data-tab="#tab3">Large Dog</button></li>
        </ul>
            ...
            <div className="row">
              <div className="col col-xl-3 col-sm-6">
                <div className="pricing_table_item">
                  ...
                  <ul className="pricing_info_list unorder_list_block">
                    <li><i className="fas fa-check-circle"></i><span>Bath (Hypo-Allergenic)</span></li>
                    <li><i className="fas fa-check-circle"></i><span>Conditioning Treatment</span></li>
                    <li><del><i className="fas fa-check-circle"></i><span>Ears Flushed & Cleaned</span></del></li>
                    <li><del><i className="fas fa-check-circle"></i><span>Watering Plants</span></del></li>
                    <li><del><i className="fas fa-check-circle"></i><span>Handscissor Finish</span></del></li>
                    <li><del><i className="fas fa-check-circle"></i><span>Setting Length of Coat</span></del></li>
                  </ul>
                  <Link className="btn border_primary" href="#!">Purchase Now</Link>
                </div>
              </div>
              <div className="col col-xl-3 col-sm-6">
                <div className="pricing_table_item">
              ...
              <div className="col col-xl-3 col-sm-6">
                <div className="pricing_table_item active">
                  ...
                  <Link className="btn btn_warning" href="#!">Purchase Now</Link>
                </div>
              </div>
              <div className="col col-xl-3 col-sm-6">
                <div className="pricing_table_item">
